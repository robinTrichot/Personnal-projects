...
<form class="form-signin" method="post" action="login">
    <img class="mb-4" src="${pageContext.request.contextPath}/logo.png" alt="">
    <h1 class="h3 mb-3 font-weight-normal" style="color:#FFF;">Please sign in</h1>
    <label for="inputEmail" class="sr-only">Email address</label>
    <input type="email" id="inputEmail" name="txtLogin" class="form-control" placeholder="Addresse mail" required
           autofocus>
    ...
    <button class="btn btn-lg btn-primary btn-block" style="background-color:#ff750b; border-color:#FFF;" type="submit">
        Sign in
    </button>
</form>
<!-- Optional JavaScript -->
